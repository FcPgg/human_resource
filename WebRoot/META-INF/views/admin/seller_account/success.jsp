	...
	<div class="modal-dialog " style="width: 1200px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<!--内容开始------------------------------>
				<div class="bzzx_bt">
					<strong>充值中心</strong>企业购买职位发布服务后可以发布招聘职位，并对已发布的职位进行<span>编辑、刷新、置顶</span>等管理
				</div>
...
$(document).on('click',".fwmc_xxk li",function(){  
	...
	function rechargePay() {
		...
		if($("#zfbPay").get(0).checked) {
			...
			var WIDsubject = "e币充值";
			$.post("alipay/base/alipayPc",{'WIDout_trade_no':WIDout_trade_no,'WIDtotal_amount':pay,'WIDsubject':WIDsubject},function(r){
				if(r.success){
