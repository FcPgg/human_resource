			...
			<div class="modal-body">
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="orderInfo">
						...
						<tbody>
						<tr class="am-primary">
							<td class="am-text-right am-serif">申请退货时间：</td>
							<td id="createsTime">
							</td>
							<td class="am-text-right am-serif">申请人</td>
							<td id="applicant">
							</td>
							<td class="am-text-right am-serif">退货理由</td>
							<td id="reason">
							</td>
						</tr>
						<tr class="am-primary">
							<td class="am-text-right am-serif">商品状态</td>
							<td id="statusName">
							</td>
							<td class="am-text-right am-serif">退货快递</td>
							<td id="streamCompany">
							</td>
							<td class="am-text-right am-serif">退货快递单号</td>
							<td id="streamNo">
							</td>
						</tr>
						<tr class="am-primary">
							...
							<td class="am-text-right am-serif">商家负责人</td>
							<td id="responsiblePeson">
							</td>
							<td class="am-text-right am-serif">负责人电话</td>
							<td id="phoneNumber">
							</td>
						</tr>
						<tr class="am-primary">
						...
						<tr class="am-success">
							<th>
								<button onclick="refund()" id="refund" class="am-btn am-btn-warning" href="javascript:void(0)">
								<i class="am-icon-check "></i>退款</button>
...
<script>
 ...
 function refund(){
	var data={
			...
			'operatorId':$("#currentUserId").val()
		}
	$.post("mt/mtCreditOrder/refundAgree",data,function(r){	
		if(r.success){
			alert("操作成功！")
