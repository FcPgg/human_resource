...
DataSourceTree.prototype.data = function(options, callback) {
	...
	if(!("name" in options) && !("type" in options)){
		...
		if("data" in options && "children" in options.data)
			$data = options.data.children;
		else $data = {}//no data
	}
...
tree_data['vehicles']['data']['children']['cars']['data'] = {
	'children' : {
...
tree_data_2['pictures']['data']['children']['camera']['data'] = {
	'children' : [
