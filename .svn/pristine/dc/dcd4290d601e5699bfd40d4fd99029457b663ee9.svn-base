...
<div class=" admin-content">     
			...
			<div class="am-panel am-panel-default">
			  ...
			  <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" onclick="saveRecharge()"  id="saveRecharge" style="margin-left:92%">账户充值</button>
			  </div>
			  ...
			  <div class="am-panel-bd">
				...
				<div class="infobox infobox-blue2" style="width: 380px; height: 220px;">
					<div class="infobox-progress">
						<div id="sellerStat" data-dimension="190" data-text="35%" data-info="剩余" data-width="15" data-fontsize="38" data-percent="15" data-fgcolor="#61a9dc" data-bgcolor="#eee" data-fill="#ddd"></div>
					</div>
				...
				<div class="infobox infobox-blue2" style="width: 380px; height: 220px;">
					<div class="infobox-progress">
						<div id="goodsStat" data-dimension="190" data-text="79%" data-info="剩余" data-width="15" data-fontsize="38" data-percent="79" data-fgcolor="#7ea568" data-bgcolor="#eee" data-fill="#ddd"></div>
					</div>
				...
				<div class="infobox infobox-blue2" style="width: 380px; height: 220px;">
					...
					<div class="infobox-data" style="left: 70px; top:10px;">
						<span class="infobox-text" style="font-size:30px;">商家E币余额（个）</span>
                           <input type="text" style="display:none" value="" id="surplusMoney"/>
					</div>
					<div class="surplusMoneys">
                    </div>
                      <button type="button" style="margin-left: 150px; margin-top:15px;" class="am-btn am-btn-secondary"onclick="integralWithdrawalsPage()">提现</button>
				</div>
				
				<div class="infobox infobox-blue2" style="width: 380px; height: 220px;">

					<div class="infobox-data" style="left: 90px; top:10px;">
						<span class="infobox-text" style="font-size:30px;">商家余额(元)</span>
                           <input type="text" style="display:none" value="" id="surplusMoney"/>
					</div>
				...
				<div class=" admin-content">     
			<div class="am-panel am-panel-default">
			  <div class="am-panel-hd" style="height: 40px;">商家e币交易记录</div>
			  <div class="am-panel-bd">
			  	<hr/>
		          <table class="am-table am-table-bordered am-table-radius am-table-striped table-condensed  table-striped">
		            <thead >
		              <tr class="am-default " id="goods-table-head">
		                <th class="source am-text-center" style="width: 150px;">资金流向</th>
		                <th class="amount am-text-center" style="width: 150px;">交易金额（E币）</th>
		                <th class="tradeTime am-text-center" style="width: 150px;">交易时间</th>
		                <th class="operator am-text-center" style="width: 150px;">操作人</th>
		                <th class="remark am-text-center" style="width: 150px;">备注</th>
		              </tr>
		            </thead>
 ...
 *商家账户余额
 */
 $.post("mt/sellerAmount/getAmountSurplusMoeny",{sellerId:$("#sellerId").val()},function(r){
 ...
 *商家充值
 */
 $.post("mt/sellerVoucherCenter/list",null,function(r){
	  var $li = $(".fwmc_xxk").children("li.on");
	  $.each(r.data, function(i){
			list ='<li id="'+this.id+'" class="'+(i < 1? "on" : "")+'"><p>'+this.ecoinNumber+'e币</p><i>'+this.rechargePrice+'</i>元</li>'
			$(list).appendTo(".fwmc_xxk");
      });
});
//商家充值page
function saveRecharge(){
   $("#dialogs").modal("show");
	$("#dialogLabel").html('e币充值');
}
...
function withdrawalsPage(){
	...
	$("#dialogLabel").html('余额提现');
}

//积分提现页
function integralWithdrawalsPage(){
	$("#integralWithdrawalsPage").modal("show");
	$("#dialogLabel").html('积分提现');
}
...
<jsp:include page="./seller_recharge.jsp"></jsp:include>
<jsp:include page="./seller_withdrawals.jsp"></jsp:include>
<jsp:include page="./seller_integral_withdrawals.jsp"></jsp:include>
</html>