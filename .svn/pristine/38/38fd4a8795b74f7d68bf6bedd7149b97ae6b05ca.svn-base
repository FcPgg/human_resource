		...
		<div class="modal-content">
			...
			<div class="modal-body">				
				<ul class="nav nav-tabs" role="tablist">
                    <li class="active"><a href="#category" role="tab" data-toggle="tab">商家提现</a></li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="category">
                    	...
                    	<!--   <input class="data-id" id="data-id" style="display: none;"/> -->
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-11">
						      <input type="text" class="form-control" name="name" id="alipayAccountNumber" placeholder="请输入支付宝账户" required>
...
function withdrawals(){	
    ...
    if($("#alipayAmount").val() >$("#moneyAccount").val()){
	  ...
	  var alipayAccountNumber = $("#alipayAccountNumber").val();
	  var alipayAmount = $("#alipayAmount").val();
	     
     $.post("mt/sellerAmount/sellerWithdrawals",{"sellerId":sellerId,"alipayAccountNumber":alipayAccountNumber,"alipayAmount":alipayAmount},function(r){
    	 if(r.success){
			alert("操作成功！")
