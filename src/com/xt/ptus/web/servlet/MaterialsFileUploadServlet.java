...
public class MaterialsFileUploadServlet extends HttpServlet {
	
	private static Logger logger = Logger.getLogger(MaterialsFileUploadServlet.class);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<MtCommonAttachements> atts = new ArrayList<MtCommonAttachements>();
			// 可以上传多个文件
...
//				String name = item.getFieldName();
				...
				att.setSrcName(fileName.substring(0, fileName.lastIndexOf(".")));
